...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("2. 메뉴 코드로 전체 조회");
            System.out.println("3. 신규메뉴 추가");
            System.out.println("4. 메뉴 수정");
            System.out.println("5. 메뉴 삭제");
            System.out.println("6. 가격으로 메뉴 조회");
            ...
            switch (no){
                ...
                case 6 : menuController.samePriceMenu(inputMenuPrice());break;
                default:
    ...
    private static Map<String,String> inputMenuPrice(){
        Scanner sc = new Scanner(System.in);
        System.out.print("조회하고 싶은 메뉴 가격울 입력하세요 : ");
        String price = sc.nextLine();
